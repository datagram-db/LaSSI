...
from FunctionalMatch.example.parmenides.Parmenides import CasusHappening
...
class ModelSearch:
    ...
    def searchInSet(self, lhs, rhsSet):
        ...
        for rhs in rhsSet:
            from FunctionalMatch.example.LaSSI.eFOLsemantics.ExpandConstituents import test_pairwise_sentence_similarity
            ...
            from FunctionalMatch.example.LaSSI.eFOLsemantics.ExpandConstituents import isImplication
