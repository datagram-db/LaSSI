...
if __name__ == '__main__':
    ...
    pipeline = LaSSI(dataset_name, fuzzyDBs, SentenceRepresentation.FullText, transformer="Log#qbao775/AMR-LE-DeBERTa-V2-XXLarge-Contraposition-Double-Negation-Implication-Commutative-Pos-Neg-1-3")
    pipeline.run()
    pipeline.close()
