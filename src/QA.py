...
from Formulae import FVariable, FUnaryPredicate, FBinaryPredicate, FNot, FAnd
...
def q1():
    ...
    sammy = FVariable("sammy", "ENTITY", None, None, 1)
    ...
    go = FUnaryPredicate("go", sammy, 1, frozenset(( ("SPACE", (people_be,)) )) )
...
def q2():
    ...
    you = FVariable("you", "ENTITY", None, None, 1)
    where = FVariable("?1", "ENTITY", None, None, 1)
...
def q3():
    ...
    is_a = FBinaryPredicate("isA", what, he, -1, frozenset())
    require = FBinaryPredicate("require", what, cable, -1, frozenset())

    return FAnd((is_a, require))
